...
var _gemidao=require('./gemidao');var _gemidao2=_interopRequireDefault(_gemidao);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}

var emitSuccess=function emitSuccess(message){return console.log((0,_safe.green)(' \u2714 Sucesso: '+message));};
var emitError=function emitError(message){return console.log((0,_safe.red)(' \u2717 Erro: '+message));};

function cli(args){
(0,_gemidao2.default)(args).
then(function(){
